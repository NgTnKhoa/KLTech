...
export function RegisterForm({className, onSubmit, message}: RegisterFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const validData = registerSchema.parse(formData) as RegisterFormData;
      setErrors({});
      onSubmit?.(validData);
    } catch (error) {
